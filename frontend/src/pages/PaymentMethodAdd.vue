    ...
    <div class="bg-surface-container-lowest rounded-xl shadow-sm p-6 space-y-5">
      <div>
        ...
        <div class="relative mt-1.5">
          <input placeholder="1234 5678 9012 3456" class="w-full bg-surface-container-low border-none rounded-lg pl-3 pr-10 py-2.5 text-sm font-medium tracking-wide text-on-surface placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-fixed-dim"/>
      ...
      <div>
        ...
        <input placeholder="Jane Doe" class="w-full mt-1.5 bg-surface-container-low border-none rounded-lg px-3 py-2.5 text-sm font-medium text-on-surface placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-fixed-dim"/>
      </div>

      <div class="grid grid-cols-2 gap-4">
        <div>
          <label class="text-xs font-medium text-on-surface-variant">Expiry date</label>
          <input placeholder="MM / YY" class="w-full mt-1.5 bg-surface-container-low border-none rounded-lg px-3 py-2.5 text-sm font-medium text-on-surface placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-fixed-dim"/>
        </div>
        <div>
